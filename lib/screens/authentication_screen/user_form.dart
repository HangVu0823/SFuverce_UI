...
import 'package:sfuverce_app/screens/authentication_screen/widget/myTextField.dart';
  ...
  sendUserDataToDB() async {
    ...
    return _collectionRef
        ...
        .then((value) => Navigator.push(
            context, MaterialPageRoute(builder: (_) => PageNavigation())))
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                      fontSize: 22, color: Color.fromARGB(255, 157, 184, 225)),
                ),
                Text(
